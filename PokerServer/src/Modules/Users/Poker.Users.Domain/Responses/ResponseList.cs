...
public static class ResponseList
{
    ...
    public static Response IncorrectPassword =>
        Response.Create(ErrorMessages.IncorrectPassword, HttpStatusCode.Unauthorized);
    ...
    public static Response InvalidVerificationToken =>
        Response.Create(ErrorMessages.InvalidVerificationToken, HttpStatusCode.BadRequest);
}